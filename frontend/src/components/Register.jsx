    ...
    return (
        <div className="w-full max-w-md mx-auto mt-10 p-8 bg-panel rounded-2xl border border-white/5 shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-8">
                ...
                <p className="text-textMuted">Start tracking your focus and crushing goals</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-6 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:hover:bg-emerald-600 text-white px-5 py-3 rounded-xl transition-all font-bold flex justify-center items-center shadow-lg hover:shadow-emerald-500/20 active:scale-95"
                >
                    {loading ? 'Signing up...' : (
                        <>
            ...
            <div className="mt-6 text-center text-sm text-textMuted">
                ...
                <button
                    ...
                    className="text-emerald-400 hover:text-emerald-300 hover:underline transition-all font-medium"
                >
                    Log in
                </button>
            </div>
